    ...
    return (
        <div className=" hover:h-40 group datas-center m-3">
            <div className="relative">
                <img src={data?.image} alt={data?.title} className="w-full h-[100%] group-hover:!opacity-0 group-hover:!duration-700" />
                <img src={data?.HoverImage} alt={data?.title} className="absolute top-0 left-0 w-full h-[100%] group-hover:!opacity-100 transition-opacity !duration-700 opacity-0 " />
                <p className="bg-[#d11e33] absolute p-0.5 text-xs px-1 font-semibold top-2 left-2 rounded-sm text-white">Sale {data?.discount}</p>
                <div className=" opacity-0 group-hover:!opacity-100 duration-300 absolute top-0 m-2 right-0">
                    <div className=" bg-white hover:!bg-[#d11e33] hover:!border-[#d11e33] mb-2 hover:text-white border h-12 w-12 text-center rounded-full grid place-content-center">
            ...
            <div className="bg-white group-hover:-translate-y-12 transition-all duration-500 flex flex-col items-center">
                ...
                <div className="flex m-0 space-x-2">
                    <h6 className="text-[#d11e33] text-sm">Rs.{data?.price}.00 </h6>
                    <h6 className="text-[#191919] text-sm line-through">
                        Rs.{data?.old_price}.00
                    </h6>
                </div>
