...
//                             <marquee style={{ backgroundColor: "#e7e7e7", height: "41px", color: "black" }}>
...
//                                 <h1 className='pb-4'>Shopping Cart</h1>
...
//                                                         <img src={e?.productId?.images} />
//                                                     </div>
//                                                     <div class="product-details">
//                                                         <div class="product-title">{e?.productId?.title}</div>
//                                                         <p class="product-description">{e?.productId?.description}</p>
//                                                     </div>
